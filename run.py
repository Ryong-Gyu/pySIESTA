...
def _build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--verbose", type=_str2bool, default=True, metavar="BOOL",
                        help="Enable tqdm/log output (true/false)")
    ...
    parser.add_argument("--optimizer-nesterov", type=_str2bool, default=False, metavar="BOOL",
                        help="Use Nesterov momentum (true/false)")
